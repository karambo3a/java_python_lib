...
JNIEXPORT jobject JNICALL Java_org_python_integration_object_PythonCallable_from__Ljava_util_function_Consumer_2(JNIEnv *env, jclass cls, jobject java_consumer) {
    if (!java_consumer) {
    ...
    PyJavaFunctionObject* py_java_consumer = create_py_java_function_object(env, java_consumer, env->GetMethodID(consumer_class, "accept", "(Ljava/lang/Object;)V"), 1, true);

    return convert_to_python_callable(env, (PyObject *)py_java_consumer);
}


JNIEXPORT jobject JNICALL Java_org_python_integration_object_PythonCallable_from__Ljava_util_function_Supplier_2(JNIEnv *env, jclass cls, jobject java_supplier) {
    if (!java_supplier) {
    ...
    PyJavaFunctionObject* py_java_supplier = create_py_java_function_object(env, java_supplier, env->GetMethodID(supplier_class, "get", "()Ljava/lang/Object;"), 0);

    return convert_to_python_callable(env, (PyObject *)py_java_supplier);
}


JNIEXPORT jobject JNICALL Java_org_python_integration_object_PythonCallable_from__Ljava_util_function_Function_2(JNIEnv *env, jclass cls, jobject java_function) {
    if (!java_function) {
    ...
    PyJavaFunctionObject* py_java_function = create_py_java_function_object(env, java_function, env->GetMethodID(function_class, "apply", "(Ljava/lang/Object;)Ljava/lang/Object;"), 1);

    return convert_to_python_callable(env, (PyObject *)py_java_function);
}


JNIEXPORT jobject JNICALL Java_org_python_integration_object_PythonCallable_from__Ljava_util_function_BiFunction_2(JNIEnv *env, jclass cls, jobject java_bi_function)  {
    if (!java_bi_function) {
    ...
    PyJavaFunctionObject* py_java_bi_function = create_py_java_function_object(env, java_bi_function, env->GetMethodID(bi_function_class, "apply", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"), 2);
